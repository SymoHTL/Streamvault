    ...
    <div className="group relative rounded-lg overflow-visible bg-surface-secondary dark:bg-surface-secondary-dark cursor-pointer">
      <Link to={linkTo} className="block rounded-lg overflow-hidden">
        <div className="aspect-[2/3] relative overflow-hidden bg-border dark:bg-border-dark">
          ...
          <div className="absolute top-1.5 right-1.5 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10">
            <button
              ...
              className="w-8 h-8 rounded-full bg-black/60 hover:bg-success/80 text-white flex items-center justify-center backdrop-blur-sm transition-colors"
            ...
            <button
              ...
              className="w-8 h-8 rounded-full bg-black/60 hover:bg-primary/80 text-white flex items-center justify-center backdrop-blur-sm transition-colors"
            ...
            <button
              ...
              className="w-8 h-8 rounded-full bg-black/60 hover:bg-white/30 text-white flex items-center justify-center backdrop-blur-sm transition-colors"
              title="More options"
            >
        ...
        <div className="p-2.5">
          ...
          <div className="flex items-center gap-2 mt-0.5 text-xs text-muted dark:text-muted-dark">
